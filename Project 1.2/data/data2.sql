-- CHANGE BUDGET INTO BIGINT BEFORE EXECUTING THIS QUERY
...
-- CHANGE NATIONALITY INTO VARCHAR(50) BEFORE EXECUTING THIS QUERY
...
-- ADD COUNTRY AS VARCHAR(10) BEFORE EXECUTING THIS QUERY
